...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } = CK_MENU_CATEGORY_API_CONFIG.FIELDS.UPDATE_OWNERTYPE;
const isDebug = true;

const CK_menuCategory_update_ownerType = async (payload) => {
...
export default CK_menuCategory_update_ownerType;
