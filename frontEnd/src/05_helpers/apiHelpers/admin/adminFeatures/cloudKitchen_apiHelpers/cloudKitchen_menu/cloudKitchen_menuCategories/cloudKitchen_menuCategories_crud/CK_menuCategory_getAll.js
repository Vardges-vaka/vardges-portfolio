...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } = CK_MENU_CATEGORY_API_CONFIG.CRUD.GETALL;
const isDebug = true;

const CK_menuCategory_getAll = async (payload) => {
...
export default CK_menuCategory_getAll;
