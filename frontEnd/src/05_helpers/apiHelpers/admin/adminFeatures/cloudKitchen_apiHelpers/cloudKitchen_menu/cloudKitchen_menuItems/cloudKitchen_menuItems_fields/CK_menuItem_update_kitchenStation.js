...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_ITEMS_API_CONFIG.FIELDS.UPDATE_KITCHENSTATION;
const isDebug = true;

const CK_menuItem_update_kitchenStation = async (payload) => {
...
export default CK_menuItem_update_kitchenStation;
