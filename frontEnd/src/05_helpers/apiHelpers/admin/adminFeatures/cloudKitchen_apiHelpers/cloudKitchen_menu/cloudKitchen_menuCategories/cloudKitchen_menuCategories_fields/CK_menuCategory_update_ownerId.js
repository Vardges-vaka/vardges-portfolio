...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } = CK_MENU_CATEGORY_API_CONFIG.FIELDS.UPDATE_OWNERID;
const isDebug = true;

const CK_menuCategory_update_ownerId = async (payload) => {
...
export default CK_menuCategory_update_ownerId;
