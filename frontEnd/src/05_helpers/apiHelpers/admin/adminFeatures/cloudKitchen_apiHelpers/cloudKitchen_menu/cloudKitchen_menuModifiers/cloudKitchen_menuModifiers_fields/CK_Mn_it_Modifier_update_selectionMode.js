...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_ITEM_MODIFIERS_API_CONFIG.FIELDS.UPDATE_SELECTIONMODE;
const isDebug = true;

const CK_Mn_it_Modifier_update_selectionMode = async (payload) => {
...
export default CK_Mn_it_Modifier_update_selectionMode;
