...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_ITEM_MODIFIERS_API_CONFIG.RELATIONS.REMOVE_OPTIONS;
const isDebug = true;

const CK_Mn_it_Modifier_removeOptions = async (payload) => {
...
export default CK_Mn_it_Modifier_removeOptions;
