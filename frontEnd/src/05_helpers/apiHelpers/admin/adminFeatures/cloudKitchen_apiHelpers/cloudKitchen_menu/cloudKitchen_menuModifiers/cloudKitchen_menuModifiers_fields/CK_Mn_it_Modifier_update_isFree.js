...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_ITEM_MODIFIERS_API_CONFIG.FIELDS.UPDATE_ISFREE;
const isDebug = true;

const CK_Mn_it_Modifier_update_isFree = async (payload) => {
...
export default CK_Mn_it_Modifier_update_isFree;
