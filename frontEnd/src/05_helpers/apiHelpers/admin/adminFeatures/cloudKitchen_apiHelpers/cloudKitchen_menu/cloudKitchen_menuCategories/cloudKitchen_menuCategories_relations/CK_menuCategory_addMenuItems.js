...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } = CK_MENU_CATEGORY_API_CONFIG.RELATIONS.ADD_MENUITEMS;
const isDebug = true;


const CK_menuCategory_addMenuItems = async (payload) => {
...
export default CK_menuCategory_addMenuItems;
