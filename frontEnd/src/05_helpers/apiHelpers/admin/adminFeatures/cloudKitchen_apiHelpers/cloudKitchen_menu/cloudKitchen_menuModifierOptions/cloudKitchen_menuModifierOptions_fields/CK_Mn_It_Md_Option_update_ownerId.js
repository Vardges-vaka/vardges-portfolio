...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_ITEM_MODIFIER_OPTIONS_API_CONFIG.FIELDS.UPDATE_OWNERID;
const isDebug = true;

const CK_Mn_It_Md_Option_update_ownerId = async (payload) => {
...
export default CK_Mn_It_Md_Option_update_ownerId;
