...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_MENU_CATEGORY_API_CONFIG.CRUD.GET_MENUITEMS_POPULATED;
const isDebug = true;

const CK_menuCategory_getMenuItemsPopulated = async (payload) => {
...
export default CK_menuCategory_getMenuItemsPopulated;
