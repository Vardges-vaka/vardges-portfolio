...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.FIELDS.UPDATE_MENUS;
const isDebug = true;

const CK_brnd_competitor_update_menus = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update competitor menus",
    ...
    return {
      success: false,
      message: error.message || "Failed to update competitor menus",
      data: null,
    };
  }
};

export default CK_brnd_competitor_update_menus;
