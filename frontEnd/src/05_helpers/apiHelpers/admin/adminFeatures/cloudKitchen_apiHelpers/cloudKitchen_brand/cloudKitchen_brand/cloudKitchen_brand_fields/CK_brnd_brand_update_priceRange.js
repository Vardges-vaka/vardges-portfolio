...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_PRICERANGE;
const isDebug = true;

const CK_brnd_brand_update_priceRange = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand priceRange",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand priceRange",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_priceRange;
