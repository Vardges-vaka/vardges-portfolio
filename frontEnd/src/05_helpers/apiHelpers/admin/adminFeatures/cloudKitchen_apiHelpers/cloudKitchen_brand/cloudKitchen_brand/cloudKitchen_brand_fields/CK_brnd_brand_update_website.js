...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_WEBSITE;
const isDebug = true;

const CK_brnd_brand_update_website = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand website",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand website",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_website;
