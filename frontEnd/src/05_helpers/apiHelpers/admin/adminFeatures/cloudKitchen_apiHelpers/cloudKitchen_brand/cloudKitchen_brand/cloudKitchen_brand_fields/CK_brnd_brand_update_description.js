...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_DESCRIPTION;
const isDebug = true;

const CK_brnd_brand_update_description = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand description",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand description",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_description;
