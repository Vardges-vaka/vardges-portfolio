...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_SIBLINGS;
const isDebug = true;

const CK_brnd_brand_update_siblings = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand siblings",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand siblings",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_siblings;
