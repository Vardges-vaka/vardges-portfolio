...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_EMPLOYEES;
const isDebug = true;

const CK_brnd_brand_update_employees = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand employees",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand employees",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_employees;
