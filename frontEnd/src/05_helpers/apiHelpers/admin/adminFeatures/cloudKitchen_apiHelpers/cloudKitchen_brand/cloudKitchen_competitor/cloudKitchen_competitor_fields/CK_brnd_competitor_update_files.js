...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.FIELDS.UPDATE_FILES;
const isDebug = true;

const CK_brnd_competitor_update_files = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update competitor files",
    ...
    return {
      success: false,
      message: error.message || "Failed to update competitor files",
      data: null,
    };
  }
};

export default CK_brnd_competitor_update_files;
