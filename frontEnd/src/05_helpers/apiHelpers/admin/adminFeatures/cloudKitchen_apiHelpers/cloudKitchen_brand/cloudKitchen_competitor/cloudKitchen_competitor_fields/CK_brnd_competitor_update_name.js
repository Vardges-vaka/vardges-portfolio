...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_brnd_competitor_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update competitor name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update competitor name",
      data: null,
    };
  }
};

export default CK_brnd_competitor_update_name;
