...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_brnd_competitor_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update competitor",
...
export default CK_brnd_competitor_updateAll;
