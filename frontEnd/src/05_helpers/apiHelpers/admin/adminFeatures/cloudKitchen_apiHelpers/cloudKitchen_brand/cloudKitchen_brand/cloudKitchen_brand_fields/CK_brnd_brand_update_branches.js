...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_BRANCHES;
const isDebug = true;

const CK_brnd_brand_update_branches = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand branches",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand branches",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_branches;
