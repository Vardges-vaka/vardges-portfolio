...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_EQUIPMENTS;
const isDebug = true;

const CK_brnd_brand_update_equipments = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand equipments",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand equipments",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_equipments;
