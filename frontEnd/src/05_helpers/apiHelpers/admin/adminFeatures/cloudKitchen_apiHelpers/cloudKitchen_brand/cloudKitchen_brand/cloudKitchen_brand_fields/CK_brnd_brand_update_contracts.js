...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_CONTRACTS;
const isDebug = true;

const CK_brnd_brand_update_contracts = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand contracts",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand contracts",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_contracts;
