...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_MENUS;
const isDebug = true;

const CK_brnd_brand_update_menus = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand menus",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand menus",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_menus;
