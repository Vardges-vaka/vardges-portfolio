...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_COMPETITORS;
const isDebug = true;

const CK_brnd_brand_update_competitors = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand competitors",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand competitors",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_competitors;
