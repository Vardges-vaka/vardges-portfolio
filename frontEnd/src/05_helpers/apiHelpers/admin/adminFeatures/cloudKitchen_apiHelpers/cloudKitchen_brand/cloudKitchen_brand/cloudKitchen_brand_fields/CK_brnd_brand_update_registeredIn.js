...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_REGISTEREDIN;
const isDebug = true;

const CK_brnd_brand_update_registeredIn = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand registeredIn",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand registeredIn",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_registeredIn;
