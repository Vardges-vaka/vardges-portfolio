...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_INTEGRATIONS;
const isDebug = true;

const CK_brnd_brand_update_integrations = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand integrations",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand integrations",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_integrations;
