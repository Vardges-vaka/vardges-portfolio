...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRAND_CONFIG.FIELDS.UPDATE_SOCIALS;
const isDebug = true;

const CK_brnd_brand_update_socials = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update brand socials",
    ...
    return {
      success: false,
      message: error.message || "Failed to update brand socials",
      data: null,
    };
  }
};

export default CK_brnd_brand_update_socials;
