...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_brnd_competitor_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete competitor",
...
export default CK_brnd_competitor_delete;
