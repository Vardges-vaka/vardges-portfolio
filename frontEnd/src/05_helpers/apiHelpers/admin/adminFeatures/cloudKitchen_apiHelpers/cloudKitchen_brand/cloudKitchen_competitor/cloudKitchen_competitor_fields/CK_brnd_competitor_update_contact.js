...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_COMPETITOR_CONFIG.FIELDS.UPDATE_CONTACT;
const isDebug = true;

const CK_brnd_competitor_update_contact = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update competitor contact",
    ...
    return {
      success: false,
      message: error.message || "Failed to update competitor contact",
      data: null,
    };
  }
};

export default CK_brnd_competitor_update_contact;
