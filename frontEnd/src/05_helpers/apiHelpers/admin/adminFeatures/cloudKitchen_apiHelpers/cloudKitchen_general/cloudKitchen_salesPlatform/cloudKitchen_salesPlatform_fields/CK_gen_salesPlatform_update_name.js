...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_PLATFORM_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_gen_salesPlatform_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales platform name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales platform name",
      data: null,
    };
  }
};

export default CK_gen_salesPlatform_update_name;
