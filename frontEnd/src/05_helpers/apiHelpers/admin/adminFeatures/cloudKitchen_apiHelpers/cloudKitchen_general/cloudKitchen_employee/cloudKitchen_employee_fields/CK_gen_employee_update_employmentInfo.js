...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_EMPLOYMENTINFO;
const isDebug = true;

const CK_gen_employee_update_employmentInfo = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee employmentInfo",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee employmentInfo",
      data: null,
    };
  }
};

export default CK_gen_employee_update_employmentInfo;
