...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_COMMENT;
const isDebug = true;

const CK_gen_rating_update_comment = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating comment",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating comment",
      data: null,
    };
  }
};

export default CK_gen_rating_update_comment;
