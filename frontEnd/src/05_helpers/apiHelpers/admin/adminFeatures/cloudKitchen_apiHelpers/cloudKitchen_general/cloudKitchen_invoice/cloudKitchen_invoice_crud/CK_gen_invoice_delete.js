...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INVOICE_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_invoice_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete invoice",
...
export default CK_gen_invoice_delete;
