...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_employee_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee notes",
      data: null,
    };
  }
};

export default CK_gen_employee_update_notes;
