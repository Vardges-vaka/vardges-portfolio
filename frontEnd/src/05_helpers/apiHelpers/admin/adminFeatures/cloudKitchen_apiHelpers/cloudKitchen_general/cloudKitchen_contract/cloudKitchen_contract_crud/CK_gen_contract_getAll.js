...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.CRUD.GET_ALL;
const isDebug = true;

const CK_gen_contract_getAll = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to fetch contract",
...
export default CK_gen_contract_getAll;
