...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_HISTORY;
const isDebug = true;

const CK_gen_contract_update_history = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract history",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract history",
      data: null,
    };
  }
};

export default CK_gen_contract_update_history;
