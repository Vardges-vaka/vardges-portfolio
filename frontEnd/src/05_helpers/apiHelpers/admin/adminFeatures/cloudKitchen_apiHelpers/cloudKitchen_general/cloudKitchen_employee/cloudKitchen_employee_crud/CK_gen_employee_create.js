...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.CRUD.CREATE;
const isDebug = true;

const CK_gen_employee_create = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to create employee",
...
export default CK_gen_employee_create;
