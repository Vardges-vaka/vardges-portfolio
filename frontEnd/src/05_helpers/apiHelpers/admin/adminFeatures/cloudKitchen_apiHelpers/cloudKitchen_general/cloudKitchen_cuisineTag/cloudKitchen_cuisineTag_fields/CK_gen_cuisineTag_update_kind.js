...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.FIELDS.UPDATE_KIND;
const isDebug = true;

const CK_gen_cuisineTag_update_kind = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update cuisine tag kind",
    ...
    return {
      success: false,
      message: error.message || "Failed to update cuisine tag kind",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_update_kind;
