...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_CHANNEL_CONFIG.FIELDS.UPDATE_BRAND;
const isDebug = true;

const CK_gen_salesChannel_update_brand = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales channel brand",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales channel brand",
      data: null,
    };
  }
};

export default CK_gen_salesChannel_update_brand;
