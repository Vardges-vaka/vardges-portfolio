...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_FILES;
const isDebug = true;

const CK_gen_equipment_update_files = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment files",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment files",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_files;
