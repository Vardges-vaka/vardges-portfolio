...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_SOURCE;
const isDebug = true;

const CK_gen_rating_update_source = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating source",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating source",
      data: null,
    };
  }
};

export default CK_gen_rating_update_source;
