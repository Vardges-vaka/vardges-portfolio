...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_SOURCE;
const isDebug = true;

const CK_gen_customer_update_source = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer source",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer source",
      data: null,
    };
  }
};

export default CK_gen_customer_update_source;
