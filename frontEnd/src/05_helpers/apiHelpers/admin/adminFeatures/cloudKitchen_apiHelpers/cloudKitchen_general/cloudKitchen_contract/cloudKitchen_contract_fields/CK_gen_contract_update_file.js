...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_FILE;
const isDebug = true;

const CK_gen_contract_update_file = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract file",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract file",
      data: null,
    };
  }
};

export default CK_gen_contract_update_file;
