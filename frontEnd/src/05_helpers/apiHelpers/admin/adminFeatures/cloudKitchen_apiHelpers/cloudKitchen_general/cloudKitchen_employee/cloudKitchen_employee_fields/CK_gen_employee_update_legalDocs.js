...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_LEGALDOCS;
const isDebug = true;

const CK_gen_employee_update_legalDocs = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee legalDocs",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee legalDocs",
      data: null,
    };
  }
};

export default CK_gen_employee_update_legalDocs;
