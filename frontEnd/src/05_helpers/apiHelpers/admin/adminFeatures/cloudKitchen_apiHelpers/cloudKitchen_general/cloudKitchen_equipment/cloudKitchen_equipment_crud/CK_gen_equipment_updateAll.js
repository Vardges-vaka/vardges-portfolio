...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_equipment_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment",
...
export default CK_gen_equipment_updateAll;
