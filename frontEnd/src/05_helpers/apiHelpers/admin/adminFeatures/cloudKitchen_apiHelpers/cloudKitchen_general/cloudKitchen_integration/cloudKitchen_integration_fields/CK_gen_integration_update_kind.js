...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_KIND;
const isDebug = true;

const CK_gen_integration_update_kind = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration kind",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration kind",
      data: null,
    };
  }
};

export default CK_gen_integration_update_kind;
