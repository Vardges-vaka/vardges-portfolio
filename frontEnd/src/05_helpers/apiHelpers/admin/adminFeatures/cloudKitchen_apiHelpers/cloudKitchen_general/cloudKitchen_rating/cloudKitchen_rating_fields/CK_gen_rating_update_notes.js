...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_rating_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating notes",
      data: null,
    };
  }
};

export default CK_gen_rating_update_notes;
