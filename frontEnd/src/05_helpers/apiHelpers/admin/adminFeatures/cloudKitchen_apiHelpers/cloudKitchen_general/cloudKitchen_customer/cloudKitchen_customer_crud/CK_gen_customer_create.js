...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.CRUD.CREATE;
const isDebug = true;

const CK_gen_customer_create = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to create customer",
...
export default CK_gen_customer_create;
