...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_KAM;
const isDebug = true;

const CK_gen_integration_update_kam = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration kam",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration kam",
      data: null,
    };
  }
};

export default CK_gen_integration_update_kam;
