...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_customer_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete customer",
...
export default CK_gen_customer_delete;
