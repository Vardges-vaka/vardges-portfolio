...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_PLATFORM_CONFIG.FIELDS.UPDATE_KAM;
const isDebug = true;

const CK_gen_salesPlatform_update_kam = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales platform kam",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales platform kam",
      data: null,
    };
  }
};

export default CK_gen_salesPlatform_update_kam;
