...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_equipment_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment notes",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_notes;
