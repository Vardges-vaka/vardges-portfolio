...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_COMPLAINTS;
const isDebug = true;

const CK_gen_customer_update_complaints = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer complaints",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer complaints",
      data: null,
    };
  }
};

export default CK_gen_customer_update_complaints;
