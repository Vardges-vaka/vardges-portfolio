...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_OPERATIONS;
const isDebug = true;

const CK_gen_branch_update_operations = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch operations",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch operations",
      data: null,
    };
  }
};

export default CK_gen_branch_update_operations;
