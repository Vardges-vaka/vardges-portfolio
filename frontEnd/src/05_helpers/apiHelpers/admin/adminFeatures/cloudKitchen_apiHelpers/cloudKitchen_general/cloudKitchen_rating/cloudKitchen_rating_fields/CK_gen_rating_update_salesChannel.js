...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_SALESCHANNEL;
const isDebug = true;

const CK_gen_rating_update_salesChannel = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating salesChannel",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating salesChannel",
      data: null,
    };
  }
};

export default CK_gen_rating_update_salesChannel;
