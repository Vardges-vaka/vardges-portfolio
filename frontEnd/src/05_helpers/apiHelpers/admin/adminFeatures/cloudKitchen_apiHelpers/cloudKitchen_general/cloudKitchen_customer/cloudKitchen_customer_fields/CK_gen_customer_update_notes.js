...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_customer_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer notes",
      data: null,
    };
  }
};

export default CK_gen_customer_update_notes;
