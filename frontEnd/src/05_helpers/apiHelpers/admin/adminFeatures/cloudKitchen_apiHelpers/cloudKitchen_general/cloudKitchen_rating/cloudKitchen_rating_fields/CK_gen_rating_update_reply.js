...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_REPLY;
const isDebug = true;

const CK_gen_rating_update_reply = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating reply",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating reply",
      data: null,
    };
  }
};

export default CK_gen_rating_update_reply;
