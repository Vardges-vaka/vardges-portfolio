...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.CRUD.GET_ONE;
const isDebug = true;

const CK_gen_rating_getOne = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to fetch rating",
...
export default CK_gen_rating_getOne;
