...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_LINKS;
const isDebug = true;

const CK_gen_integration_update_links = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration links",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration links",
      data: null,
    };
  }
};

export default CK_gen_integration_update_links;
