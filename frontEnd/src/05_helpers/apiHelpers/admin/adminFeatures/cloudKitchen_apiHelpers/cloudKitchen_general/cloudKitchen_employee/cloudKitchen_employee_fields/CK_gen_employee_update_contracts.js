...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_CONTRACTS;
const isDebug = true;

const CK_gen_employee_update_contracts = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee contracts",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee contracts",
      data: null,
    };
  }
};

export default CK_gen_employee_update_contracts;
