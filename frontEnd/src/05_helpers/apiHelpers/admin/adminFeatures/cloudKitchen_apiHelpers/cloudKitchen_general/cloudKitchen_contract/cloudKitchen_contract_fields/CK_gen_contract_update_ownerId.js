...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_OWNERID;
const isDebug = true;

const CK_gen_contract_update_ownerId = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract ownerId",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract ownerId",
      data: null,
    };
  }
};

export default CK_gen_contract_update_ownerId;
