...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_BRANDS;
const isDebug = true;

const CK_gen_integration_update_brands = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration brands",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration brands",
      data: null,
    };
  }
};

export default CK_gen_integration_update_brands;
