...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_STARS;
const isDebug = true;

const CK_gen_rating_update_stars = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating stars",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating stars",
      data: null,
    };
  }
};

export default CK_gen_rating_update_stars;
