...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_SALARY;
const isDebug = true;

const CK_gen_employee_update_salary = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee salary",
...
export default CK_gen_employee_update_salary;
