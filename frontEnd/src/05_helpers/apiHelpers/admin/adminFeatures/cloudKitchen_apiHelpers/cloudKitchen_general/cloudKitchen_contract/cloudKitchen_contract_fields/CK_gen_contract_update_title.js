...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_TITLE;
const isDebug = true;

const CK_gen_contract_update_title = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract title",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract title",
      data: null,
    };
  }
};

export default CK_gen_contract_update_title;
