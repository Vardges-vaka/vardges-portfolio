...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_CHANNEL_CONFIG.FIELDS.UPDATE_RATINGS;
const isDebug = true;

const CK_gen_salesChannel_update_ratings = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales channel ratings",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales channel ratings",
      data: null,
    };
  }
};

export default CK_gen_salesChannel_update_ratings;
