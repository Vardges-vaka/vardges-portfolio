...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_ORDER;
const isDebug = true;

const CK_gen_rating_update_order = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating order",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating order",
      data: null,
    };
  }
};

export default CK_gen_rating_update_order;
