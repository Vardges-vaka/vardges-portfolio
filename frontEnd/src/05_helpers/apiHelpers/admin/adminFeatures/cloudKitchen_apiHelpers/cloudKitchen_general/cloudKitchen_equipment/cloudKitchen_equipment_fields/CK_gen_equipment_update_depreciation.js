...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_DEPRECIATION;
const isDebug = true;

const CK_gen_equipment_update_depreciation = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment depreciation",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment depreciation",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_depreciation;
