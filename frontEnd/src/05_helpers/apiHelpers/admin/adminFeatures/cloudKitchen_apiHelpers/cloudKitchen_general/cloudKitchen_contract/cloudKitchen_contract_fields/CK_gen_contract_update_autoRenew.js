...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_AUTORENEW;
const isDebug = true;

const CK_gen_contract_update_autoRenew = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract autoRenew",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract autoRenew",
      data: null,
    };
  }
};

export default CK_gen_contract_update_autoRenew;
