...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_rating_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating",
...
export default CK_gen_rating_updateAll;
