...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_CATEGORY;
const isDebug = true;

const CK_gen_equipment_update_category = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment category",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment category",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_category;
