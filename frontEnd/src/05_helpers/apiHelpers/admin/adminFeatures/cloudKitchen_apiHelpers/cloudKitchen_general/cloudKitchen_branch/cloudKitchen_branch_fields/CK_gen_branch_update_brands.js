...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_BRANDS;
const isDebug = true;

const CK_gen_branch_update_brands = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch brands",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch brands",
      data: null,
    };
  }
};

export default CK_gen_branch_update_brands;
