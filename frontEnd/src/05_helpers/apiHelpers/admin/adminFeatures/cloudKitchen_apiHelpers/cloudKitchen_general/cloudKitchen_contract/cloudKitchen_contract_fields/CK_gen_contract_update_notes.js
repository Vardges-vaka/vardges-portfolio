...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_contract_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract notes",
      data: null,
    };
  }
};

export default CK_gen_contract_update_notes;
