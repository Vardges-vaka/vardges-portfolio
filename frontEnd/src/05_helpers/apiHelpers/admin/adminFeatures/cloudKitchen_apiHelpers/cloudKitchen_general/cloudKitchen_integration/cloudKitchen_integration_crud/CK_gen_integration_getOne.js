...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.CRUD.GET_ONE;
const isDebug = true;

const CK_gen_integration_getOne = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to fetch integration",
...
export default CK_gen_integration_getOne;
