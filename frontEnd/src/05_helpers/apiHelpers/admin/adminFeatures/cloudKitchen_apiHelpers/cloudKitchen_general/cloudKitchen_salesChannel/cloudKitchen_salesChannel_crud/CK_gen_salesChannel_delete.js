...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_CHANNEL_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_salesChannel_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete sales channel",
    ...
    return {
      success: false,
      message: error.message || "Failed to delete sales channel",
      data: null,
    };
  }
};

export default CK_gen_salesChannel_delete;
