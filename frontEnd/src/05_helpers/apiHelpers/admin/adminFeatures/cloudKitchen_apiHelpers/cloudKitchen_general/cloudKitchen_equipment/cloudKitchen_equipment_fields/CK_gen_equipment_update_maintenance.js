...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_MAINTENANCE;
const isDebug = true;

const CK_gen_equipment_update_maintenance = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment maintenance",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment maintenance",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_maintenance;
