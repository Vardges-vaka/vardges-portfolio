...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_STATUS;
const isDebug = true;

const CK_gen_equipment_update_status = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment status",
...
export default CK_gen_equipment_update_status;
