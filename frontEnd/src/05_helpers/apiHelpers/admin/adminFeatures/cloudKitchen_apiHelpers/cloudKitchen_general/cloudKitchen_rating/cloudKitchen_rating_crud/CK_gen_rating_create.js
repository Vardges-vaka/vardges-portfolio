...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.CRUD.CREATE;
const isDebug = true;

const CK_gen_rating_create = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to create rating",
...
export default CK_gen_rating_create;
