...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_SENTIMENTTAG;
const isDebug = true;

const CK_gen_rating_update_sentimentTag = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating sentimentTag",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating sentimentTag",
      data: null,
    };
  }
};

export default CK_gen_rating_update_sentimentTag;
