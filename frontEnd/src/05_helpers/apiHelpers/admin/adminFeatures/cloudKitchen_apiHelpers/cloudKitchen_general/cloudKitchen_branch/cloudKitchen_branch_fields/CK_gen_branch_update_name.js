...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_gen_branch_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch name",
      data: null,
    };
  }
};

export default CK_gen_branch_update_name;
