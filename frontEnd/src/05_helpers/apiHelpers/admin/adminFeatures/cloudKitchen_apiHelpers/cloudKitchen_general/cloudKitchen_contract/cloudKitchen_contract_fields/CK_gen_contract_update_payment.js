...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_PAYMENT;
const isDebug = true;

const CK_gen_contract_update_payment = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract payment",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract payment",
      data: null,
    };
  }
};

export default CK_gen_contract_update_payment;
