...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_RELATEDTO;
const isDebug = true;

const CK_gen_employee_update_relatedTo = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee relatedTo",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee relatedTo",
      data: null,
    };
  }
};

export default CK_gen_employee_update_relatedTo;
