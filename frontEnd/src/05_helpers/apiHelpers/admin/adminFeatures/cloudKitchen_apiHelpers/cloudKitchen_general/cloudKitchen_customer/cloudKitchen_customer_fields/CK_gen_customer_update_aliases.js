...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_ALIASES;
const isDebug = true;

const CK_gen_customer_update_aliases = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer aliases",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer aliases",
      data: null,
    };
  }
};

export default CK_gen_customer_update_aliases;
