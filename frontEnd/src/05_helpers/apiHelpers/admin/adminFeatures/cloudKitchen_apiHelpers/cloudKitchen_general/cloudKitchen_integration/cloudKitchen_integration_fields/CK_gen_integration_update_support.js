...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_SUPPORT;
const isDebug = true;

const CK_gen_integration_update_support = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration support",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration support",
      data: null,
    };
  }
};

export default CK_gen_integration_update_support;
