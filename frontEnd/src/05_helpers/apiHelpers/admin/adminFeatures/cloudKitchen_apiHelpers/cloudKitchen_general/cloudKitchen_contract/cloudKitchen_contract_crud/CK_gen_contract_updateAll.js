...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_contract_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract",
...
export default CK_gen_contract_updateAll;
