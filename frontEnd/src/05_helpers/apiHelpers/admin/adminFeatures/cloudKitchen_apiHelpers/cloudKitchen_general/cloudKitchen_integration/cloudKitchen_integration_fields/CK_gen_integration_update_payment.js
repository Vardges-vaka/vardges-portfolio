...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_PAYMENT;
const isDebug = true;

const CK_gen_integration_update_payment = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration payment",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration payment",
      data: null,
    };
  }
};

export default CK_gen_integration_update_payment;
