...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_WARRANTY;
const isDebug = true;

const CK_gen_equipment_update_warranty = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment warranty",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment warranty",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_warranty;
