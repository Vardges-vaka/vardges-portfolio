...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INVOICE_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_invoice_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update invoice",
...
export default CK_gen_invoice_updateAll;
