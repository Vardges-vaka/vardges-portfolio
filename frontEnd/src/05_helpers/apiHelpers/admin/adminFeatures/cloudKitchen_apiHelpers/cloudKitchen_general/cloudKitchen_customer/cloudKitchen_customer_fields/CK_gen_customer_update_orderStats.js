...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_ORDERSTATS;
const isDebug = true;

const CK_gen_customer_update_orderStats = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer orderStats",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer orderStats",
      data: null,
    };
  }
};

export default CK_gen_customer_update_orderStats;
