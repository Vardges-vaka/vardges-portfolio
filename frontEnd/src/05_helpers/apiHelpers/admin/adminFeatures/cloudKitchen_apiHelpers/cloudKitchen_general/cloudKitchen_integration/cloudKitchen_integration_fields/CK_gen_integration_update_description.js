...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_DESCRIPTION;
const isDebug = true;

const CK_gen_integration_update_description = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration description",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration description",
      data: null,
    };
  }
};

export default CK_gen_integration_update_description;
