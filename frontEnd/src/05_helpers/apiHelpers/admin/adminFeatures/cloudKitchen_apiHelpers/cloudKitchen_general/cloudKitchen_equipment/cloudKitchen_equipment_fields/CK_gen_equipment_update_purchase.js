...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_PURCHASE;
const isDebug = true;

const CK_gen_equipment_update_purchase = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment purchase",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment purchase",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_purchase;
