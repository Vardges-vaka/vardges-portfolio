...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_CUSTOMER;
const isDebug = true;

const CK_gen_rating_update_customer = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating customer",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating customer",
      data: null,
    };
  }
};

export default CK_gen_rating_update_customer;
