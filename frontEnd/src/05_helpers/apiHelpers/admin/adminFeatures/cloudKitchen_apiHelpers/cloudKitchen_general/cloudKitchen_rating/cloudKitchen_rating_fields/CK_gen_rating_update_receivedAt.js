...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_RECEIVEDAT;
const isDebug = true;

const CK_gen_rating_update_receivedAt = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating receivedAt",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating receivedAt",
      data: null,
    };
  }
};

export default CK_gen_rating_update_receivedAt;
