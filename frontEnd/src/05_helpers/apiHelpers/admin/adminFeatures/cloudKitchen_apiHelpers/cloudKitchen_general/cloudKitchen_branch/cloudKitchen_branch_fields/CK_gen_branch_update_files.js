...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_FILES;
const isDebug = true;

const CK_gen_branch_update_files = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch files",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch files",
      data: null,
    };
  }
};

export default CK_gen_branch_update_files;
