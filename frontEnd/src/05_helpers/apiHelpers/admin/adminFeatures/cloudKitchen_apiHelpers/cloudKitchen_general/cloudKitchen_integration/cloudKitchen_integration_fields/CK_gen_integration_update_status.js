...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_STATUS;
const isDebug = true;

const CK_gen_integration_update_status = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration status",
...
export default CK_gen_integration_update_status;
