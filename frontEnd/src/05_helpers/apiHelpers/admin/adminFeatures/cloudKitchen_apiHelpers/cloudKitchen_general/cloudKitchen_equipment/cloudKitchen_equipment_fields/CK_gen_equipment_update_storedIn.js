...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_STOREDIN;
const isDebug = true;

const CK_gen_equipment_update_storedIn = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment storedIn",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment storedIn",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_storedIn;
