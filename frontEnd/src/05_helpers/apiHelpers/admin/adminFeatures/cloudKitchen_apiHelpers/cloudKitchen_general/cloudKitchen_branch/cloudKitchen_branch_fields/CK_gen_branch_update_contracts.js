...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_CONTRACTS;
const isDebug = true;

const CK_gen_branch_update_contracts = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch contracts",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch contracts",
      data: null,
    };
  }
};

export default CK_gen_branch_update_contracts;
