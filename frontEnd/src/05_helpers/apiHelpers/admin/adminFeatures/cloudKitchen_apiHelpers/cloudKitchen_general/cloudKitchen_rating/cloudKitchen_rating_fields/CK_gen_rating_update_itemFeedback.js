...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_ITEMFEEDBACK;
const isDebug = true;

const CK_gen_rating_update_itemFeedback = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating itemFeedback",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating itemFeedback",
      data: null,
    };
  }
};

export default CK_gen_rating_update_itemFeedback;
