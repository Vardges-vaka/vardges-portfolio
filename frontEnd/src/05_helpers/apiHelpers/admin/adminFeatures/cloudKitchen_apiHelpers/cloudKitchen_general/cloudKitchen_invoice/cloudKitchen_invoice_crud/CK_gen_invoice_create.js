...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INVOICE_CONFIG.CRUD.CREATE;
const isDebug = true;

const CK_gen_invoice_create = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to create invoice",
...
export default CK_gen_invoice_create;
