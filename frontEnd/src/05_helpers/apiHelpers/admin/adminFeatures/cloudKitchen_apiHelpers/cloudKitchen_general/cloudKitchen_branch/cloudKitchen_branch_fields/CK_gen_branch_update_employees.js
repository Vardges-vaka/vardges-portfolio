...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_EMPLOYEES;
const isDebug = true;

const CK_gen_branch_update_employees = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch employees",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch employees",
      data: null,
    };
  }
};

export default CK_gen_branch_update_employees;
