...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_CHANNEL_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_salesChannel_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales channel",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales channel",
      data: null,
    };
  }
};

export default CK_gen_salesChannel_updateAll;
