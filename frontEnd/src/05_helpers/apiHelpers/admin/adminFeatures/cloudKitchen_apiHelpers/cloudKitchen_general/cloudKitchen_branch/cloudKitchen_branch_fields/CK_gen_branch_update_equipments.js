...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_EQUIPMENTS;
const isDebug = true;

const CK_gen_branch_update_equipments = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch equipments",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch equipments",
      data: null,
    };
  }
};

export default CK_gen_branch_update_equipments;
