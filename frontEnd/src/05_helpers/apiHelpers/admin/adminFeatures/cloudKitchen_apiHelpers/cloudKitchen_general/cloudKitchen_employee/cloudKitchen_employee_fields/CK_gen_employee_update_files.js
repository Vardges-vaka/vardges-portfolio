...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_FILES;
const isDebug = true;

const CK_gen_employee_update_files = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee files",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee files",
      data: null,
    };
  }
};

export default CK_gen_employee_update_files;
