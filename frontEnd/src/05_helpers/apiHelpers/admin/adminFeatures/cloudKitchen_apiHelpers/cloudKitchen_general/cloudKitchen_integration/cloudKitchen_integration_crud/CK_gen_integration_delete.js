...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_integration_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete integration",
...
export default CK_gen_integration_delete;
