...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_DESCRIPTION;
const isDebug = true;

const CK_gen_equipment_update_description = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment description",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment description",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_description;
