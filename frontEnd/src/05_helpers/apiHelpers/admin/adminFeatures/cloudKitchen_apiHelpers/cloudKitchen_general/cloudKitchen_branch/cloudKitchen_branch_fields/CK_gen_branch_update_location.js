...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_LOCATION;
const isDebug = true;

const CK_gen_branch_update_location = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch location",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch location",
      data: null,
    };
  }
};

export default CK_gen_branch_update_location;
