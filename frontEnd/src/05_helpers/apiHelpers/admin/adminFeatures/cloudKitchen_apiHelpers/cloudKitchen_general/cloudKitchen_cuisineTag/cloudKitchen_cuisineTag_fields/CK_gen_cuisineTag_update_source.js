...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.FIELDS.UPDATE_SOURCE;
const isDebug = true;

const CK_gen_cuisineTag_update_source = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update cuisine tag source",
    ...
    return {
      success: false,
      message: error.message || "Failed to update cuisine tag source",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_update_source;
