...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_CONTACT;
const isDebug = true;

const CK_gen_branch_update_contact = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch contact",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch contact",
      data: null,
    };
  }
};

export default CK_gen_branch_update_contact;
