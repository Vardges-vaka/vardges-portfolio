...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_customer_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer",
...
export default CK_gen_customer_updateAll;
