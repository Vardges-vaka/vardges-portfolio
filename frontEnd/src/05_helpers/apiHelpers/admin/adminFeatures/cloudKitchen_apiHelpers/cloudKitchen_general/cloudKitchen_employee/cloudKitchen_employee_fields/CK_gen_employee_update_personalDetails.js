...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_PERSONALDETAILS;
const isDebug = true;

const CK_gen_employee_update_personalDetails = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee personalDetails",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee personalDetails",
      data: null,
    };
  }
};

export default CK_gen_employee_update_personalDetails;
