...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_PLATFORM_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_salesPlatform_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update sales platform",
    ...
    return {
      success: false,
      message: error.message || "Failed to update sales platform",
      data: null,
    };
  }
};

export default CK_gen_salesPlatform_updateAll;
