...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_CONTACT;
const isDebug = true;

const CK_gen_customer_update_contact = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer contact",
...
export default CK_gen_customer_update_contact;
