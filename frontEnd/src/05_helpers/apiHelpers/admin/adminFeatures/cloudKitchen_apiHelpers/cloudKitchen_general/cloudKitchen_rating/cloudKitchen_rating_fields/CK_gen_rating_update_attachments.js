...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.FIELDS.UPDATE_ATTACHMENTS;
const isDebug = true;

const CK_gen_rating_update_attachments = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update rating attachments",
    ...
    return {
      success: false,
      message: error.message || "Failed to update rating attachments",
      data: null,
    };
  }
};

export default CK_gen_rating_update_attachments;
