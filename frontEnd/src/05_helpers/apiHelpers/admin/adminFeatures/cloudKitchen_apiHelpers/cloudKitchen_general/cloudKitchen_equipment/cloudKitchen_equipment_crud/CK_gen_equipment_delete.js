...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_equipment_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete equipment",
...
export default CK_gen_equipment_delete;
