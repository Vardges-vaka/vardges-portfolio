...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_contract_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete contract",
...
export default CK_gen_contract_delete;
