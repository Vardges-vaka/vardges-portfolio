...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_gen_employee_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee name",
      data: null,
    };
  }
};

export default CK_gen_employee_update_name;
