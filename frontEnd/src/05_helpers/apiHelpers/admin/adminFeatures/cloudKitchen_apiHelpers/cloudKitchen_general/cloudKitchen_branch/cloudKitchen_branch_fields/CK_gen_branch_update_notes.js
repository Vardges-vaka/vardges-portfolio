...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_branch_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch notes",
      data: null,
    };
  }
};

export default CK_gen_branch_update_notes;
