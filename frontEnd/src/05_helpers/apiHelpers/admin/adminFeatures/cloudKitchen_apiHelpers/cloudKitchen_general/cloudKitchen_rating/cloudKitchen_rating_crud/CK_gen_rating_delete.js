...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_RATING_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_rating_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete rating",
...
export default CK_gen_rating_delete;
