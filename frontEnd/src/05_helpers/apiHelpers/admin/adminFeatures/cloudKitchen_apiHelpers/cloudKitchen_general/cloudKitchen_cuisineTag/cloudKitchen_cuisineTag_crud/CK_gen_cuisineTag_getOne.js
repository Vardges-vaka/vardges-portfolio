...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.CRUD.GET_ONE;
const isDebug = true;

const CK_gen_cuisineTag_getOne = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to fetch cuisine tag",
    ...
    return {
      success: false,
      message: error.message || "Failed to fetch cuisine tag",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_getOne;
