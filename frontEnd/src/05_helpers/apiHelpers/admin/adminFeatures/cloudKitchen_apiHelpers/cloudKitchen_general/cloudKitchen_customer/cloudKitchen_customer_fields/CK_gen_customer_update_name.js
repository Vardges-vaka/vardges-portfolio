...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_gen_customer_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer name",
      data: null,
    };
  }
};

export default CK_gen_customer_update_name;
