...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_BRANCH_CONFIG.FIELDS.UPDATE_EXPENSES;
const isDebug = true;

const CK_gen_branch_update_expenses = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update branch expenses",
    ...
    return {
      success: false,
      message: error.message || "Failed to update branch expenses",
      data: null,
    };
  }
};

export default CK_gen_branch_update_expenses;
