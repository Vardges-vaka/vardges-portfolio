...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_ASSETTAG;
const isDebug = true;

const CK_gen_equipment_update_assetTag = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment assetTag",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment assetTag",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_assetTag;
