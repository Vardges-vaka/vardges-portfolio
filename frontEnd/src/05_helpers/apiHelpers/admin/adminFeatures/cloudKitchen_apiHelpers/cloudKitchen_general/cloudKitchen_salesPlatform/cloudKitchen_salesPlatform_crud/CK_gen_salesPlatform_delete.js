...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_SALES_PLATFORM_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_gen_salesPlatform_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete sales platform",
    ...
    return {
      success: false,
      message: error.message || "Failed to delete sales platform",
      data: null,
    };
  }
};

export default CK_gen_salesPlatform_delete;
