...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_OWNERTYPE;
const isDebug = true;

const CK_gen_contract_update_ownerType = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract ownerType",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract ownerType",
      data: null,
    };
  }
};

export default CK_gen_contract_update_ownerType;
