...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUSTOMER_CONFIG.FIELDS.UPDATE_ADDRESSES;
const isDebug = true;

const CK_gen_customer_update_addresses = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update customer addresses",
    ...
    return {
      success: false,
      message: error.message || "Failed to update customer addresses",
      data: null,
    };
  }
};

export default CK_gen_customer_update_addresses;
