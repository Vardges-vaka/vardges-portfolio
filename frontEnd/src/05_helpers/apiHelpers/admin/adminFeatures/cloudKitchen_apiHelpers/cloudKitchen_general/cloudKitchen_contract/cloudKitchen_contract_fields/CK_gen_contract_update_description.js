...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_DESCRIPTION;
const isDebug = true;

const CK_gen_contract_update_description = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract description",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract description",
      data: null,
    };
  }
};

export default CK_gen_contract_update_description;
