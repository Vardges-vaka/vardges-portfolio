...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_STATUS;
const isDebug = true;

const CK_gen_contract_update_status = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract status",
...
export default CK_gen_contract_update_status;
