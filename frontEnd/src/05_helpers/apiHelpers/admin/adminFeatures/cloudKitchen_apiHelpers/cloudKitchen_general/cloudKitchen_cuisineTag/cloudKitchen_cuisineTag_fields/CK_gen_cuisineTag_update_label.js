...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.FIELDS.UPDATE_LABEL;
const isDebug = true;

const CK_gen_cuisineTag_update_label = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update cuisine tag label",
    ...
    return {
      success: false,
      message: error.message || "Failed to update cuisine tag label",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_update_label;
