...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EQUIPMENT_CONFIG.FIELDS.UPDATE_BRANCH;
const isDebug = true;

const CK_gen_equipment_update_branch = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update equipment branch",
    ...
    return {
      success: false,
      message: error.message || "Failed to update equipment branch",
      data: null,
    };
  }
};

export default CK_gen_equipment_update_branch;
