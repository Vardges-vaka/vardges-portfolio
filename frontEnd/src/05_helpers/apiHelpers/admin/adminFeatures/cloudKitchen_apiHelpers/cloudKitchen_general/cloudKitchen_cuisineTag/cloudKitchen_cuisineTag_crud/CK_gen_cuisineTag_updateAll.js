...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_gen_cuisineTag_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update cuisine tag",
    ...
    return {
      success: false,
      message: error.message || "Failed to update cuisine tag",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_updateAll;
