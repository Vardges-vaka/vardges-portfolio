...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_INTEGRATION_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_gen_integration_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update integration notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update integration notes",
      data: null,
    };
  }
};

export default CK_gen_integration_update_notes;
