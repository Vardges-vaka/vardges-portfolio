...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CUISINE_TAG_CONFIG.FIELDS.UPDATE_VALUE;
const isDebug = true;

const CK_gen_cuisineTag_update_value = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update cuisine tag value",
    ...
    return {
      success: false,
      message: error.message || "Failed to update cuisine tag value",
      data: null,
    };
  }
};

export default CK_gen_cuisineTag_update_value;
