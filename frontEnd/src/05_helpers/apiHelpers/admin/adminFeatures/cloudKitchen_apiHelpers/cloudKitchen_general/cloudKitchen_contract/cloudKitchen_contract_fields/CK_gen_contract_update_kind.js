...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CONTRACT_CONFIG.FIELDS.UPDATE_KIND;
const isDebug = true;

const CK_gen_contract_update_kind = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update contract kind",
    ...
    return {
      success: false,
      message: error.message || "Failed to update contract kind",
      data: null,
    };
  }
};

export default CK_gen_contract_update_kind;
