...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_EMPLOYEE_CONFIG.FIELDS.UPDATE_UNIFORM;
const isDebug = true;

const CK_gen_employee_update_uniform = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update employee uniform",
    ...
    return {
      success: false,
      message: error.message || "Failed to update employee uniform",
      data: null,
    };
  }
};

export default CK_gen_employee_update_uniform;
