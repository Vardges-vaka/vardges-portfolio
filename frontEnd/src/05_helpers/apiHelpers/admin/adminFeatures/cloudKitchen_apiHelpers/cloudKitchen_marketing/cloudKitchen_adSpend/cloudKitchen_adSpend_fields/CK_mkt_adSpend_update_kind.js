...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_KIND;
const isDebug = true;

const CK_mkt_adSpend_update_kind = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend kind",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend kind",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_kind;
