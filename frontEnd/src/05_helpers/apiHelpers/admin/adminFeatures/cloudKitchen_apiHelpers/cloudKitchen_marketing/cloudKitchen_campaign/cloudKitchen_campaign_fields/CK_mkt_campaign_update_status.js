...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_STATUS;
const isDebug = true;

const CK_mkt_campaign_update_status = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign status",
...
export default CK_mkt_campaign_update_status;
