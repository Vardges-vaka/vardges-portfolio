...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_SOURCE;
const isDebug = true;

const CK_mkt_campaign_update_source = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign source",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign source",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_source;
