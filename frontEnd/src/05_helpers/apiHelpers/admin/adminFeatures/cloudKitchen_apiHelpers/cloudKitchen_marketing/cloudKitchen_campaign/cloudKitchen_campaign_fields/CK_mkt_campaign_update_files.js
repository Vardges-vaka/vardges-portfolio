...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_FILES;
const isDebug = true;

const CK_mkt_campaign_update_files = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign files",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign files",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_files;
