...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_NAME;
const isDebug = true;

const CK_mkt_campaign_update_name = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign name",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign name",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_name;
