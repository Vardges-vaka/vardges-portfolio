...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_mkt_adSpend_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_updateAll;
