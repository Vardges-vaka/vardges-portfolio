...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_AMOUNT;
const isDebug = true;

const CK_mkt_adSpend_update_amount = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend amount",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend amount",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_amount;
