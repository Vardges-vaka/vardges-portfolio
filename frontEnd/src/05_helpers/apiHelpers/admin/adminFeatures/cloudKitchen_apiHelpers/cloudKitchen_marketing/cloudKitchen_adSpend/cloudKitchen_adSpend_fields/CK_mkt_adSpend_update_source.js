...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_SOURCE;
const isDebug = true;

const CK_mkt_adSpend_update_source = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend source",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend source",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_source;
