...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_VALUE;
const isDebug = true;

const CK_mkt_campaign_update_value = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign value",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign value",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_value;
