...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_PLATFORMPROMOID;
const isDebug = true;

const CK_mkt_campaign_update_platformPromoId = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign platformPromoId",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign platformPromoId",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_platformPromoId;
