...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_CURRENCY;
const isDebug = true;

const CK_mkt_campaign_update_currency = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign currency",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign currency",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_currency;
