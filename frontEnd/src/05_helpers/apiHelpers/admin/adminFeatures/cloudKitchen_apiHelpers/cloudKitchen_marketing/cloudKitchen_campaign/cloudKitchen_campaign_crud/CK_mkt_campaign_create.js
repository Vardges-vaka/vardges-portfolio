...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.CRUD.CREATE;
const isDebug = true;

const CK_mkt_campaign_create = async (payload) => {
  const url = ENDPOINT;
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to create campaign",
...
export default CK_mkt_campaign_create;
