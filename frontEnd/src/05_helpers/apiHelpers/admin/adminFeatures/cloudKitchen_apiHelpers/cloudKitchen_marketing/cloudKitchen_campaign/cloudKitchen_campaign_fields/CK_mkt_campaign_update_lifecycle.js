...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_LIFECYCLE;
const isDebug = true;

const CK_mkt_campaign_update_lifecycle = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign lifecycle",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign lifecycle",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_lifecycle;
