...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_KIND;
const isDebug = true;

const CK_mkt_campaign_update_kind = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign kind",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign kind",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_kind;
