...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.CRUD.GET_ONE;
const isDebug = true;

const CK_mkt_campaign_getOne = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to fetch campaign",
...
export default CK_mkt_campaign_getOne;
