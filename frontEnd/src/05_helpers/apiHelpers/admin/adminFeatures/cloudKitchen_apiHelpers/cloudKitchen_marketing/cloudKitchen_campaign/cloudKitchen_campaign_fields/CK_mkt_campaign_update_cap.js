...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_CAP;
const isDebug = true;

const CK_mkt_campaign_update_cap = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign cap",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign cap",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_cap;
