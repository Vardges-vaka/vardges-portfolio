...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.CRUD.UPDATE_ALL;
const isDebug = true;

const CK_mkt_campaign_updateAll = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign",
...
export default CK_mkt_campaign_updateAll;
