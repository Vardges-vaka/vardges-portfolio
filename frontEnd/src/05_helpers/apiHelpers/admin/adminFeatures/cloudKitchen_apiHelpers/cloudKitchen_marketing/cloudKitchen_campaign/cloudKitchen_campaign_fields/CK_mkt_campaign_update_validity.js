...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_VALIDITY;
const isDebug = true;

const CK_mkt_campaign_update_validity = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign validity",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign validity",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_validity;
