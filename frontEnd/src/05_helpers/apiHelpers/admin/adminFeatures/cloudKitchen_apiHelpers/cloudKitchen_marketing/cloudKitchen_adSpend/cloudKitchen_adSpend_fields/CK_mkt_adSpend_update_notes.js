...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_mkt_adSpend_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend notes",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_notes;
