...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_METRICS;
const isDebug = true;

const CK_mkt_adSpend_update_metrics = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend metrics",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend metrics",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_metrics;
