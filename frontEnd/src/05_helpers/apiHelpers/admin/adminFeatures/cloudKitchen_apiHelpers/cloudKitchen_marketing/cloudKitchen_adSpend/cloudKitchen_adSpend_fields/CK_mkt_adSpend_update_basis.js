...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_BASIS;
const isDebug = true;

const CK_mkt_adSpend_update_basis = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend basis",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend basis",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_basis;
