...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_NOTES;
const isDebug = true;

const CK_mkt_campaign_update_notes = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign notes",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign notes",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_notes;
