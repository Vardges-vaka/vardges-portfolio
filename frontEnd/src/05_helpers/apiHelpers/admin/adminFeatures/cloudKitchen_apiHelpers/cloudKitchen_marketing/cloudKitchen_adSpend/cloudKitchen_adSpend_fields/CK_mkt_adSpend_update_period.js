...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.FIELDS.UPDATE_PERIOD;
const isDebug = true;

const CK_mkt_adSpend_update_period = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update ad spend period",
    ...
    return {
      success: false,
      message: error.message || "Failed to update ad spend period",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_update_period;
