...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.FIELDS.UPDATE_CONDITIONS;
const isDebug = true;

const CK_mkt_campaign_update_conditions = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to update campaign conditions",
    ...
    return {
      success: false,
      message: error.message || "Failed to update campaign conditions",
      data: null,
    };
  }
};

export default CK_mkt_campaign_update_conditions;
