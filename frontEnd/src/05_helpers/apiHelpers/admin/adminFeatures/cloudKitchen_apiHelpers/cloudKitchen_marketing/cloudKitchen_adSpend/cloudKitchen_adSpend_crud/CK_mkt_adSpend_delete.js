...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_AD_SPEND_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_mkt_adSpend_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete ad spend",
    ...
    return {
      success: false,
      message: error.message || "Failed to delete ad spend",
      data: null,
    };
  }
};

export default CK_mkt_adSpend_delete;
