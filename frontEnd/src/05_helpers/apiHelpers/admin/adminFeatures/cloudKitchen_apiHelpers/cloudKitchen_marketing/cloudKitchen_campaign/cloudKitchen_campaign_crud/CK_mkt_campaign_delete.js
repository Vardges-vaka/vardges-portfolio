...
const { ENDPOINT, PROPERTIES, DISPLAY_NAME } =
  CK_CAMPAIGN_CONFIG.CRUD.DELETE;
const isDebug = true;

const CK_mkt_campaign_delete = async (payload) => {
  ...
  try {
    ...
    return {
      ...
      message: backendResponse.message || "Failed to delete campaign",
...
export default CK_mkt_campaign_delete;
