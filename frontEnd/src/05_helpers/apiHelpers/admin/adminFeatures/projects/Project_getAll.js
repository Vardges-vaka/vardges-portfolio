...
const endpoint = ADMIN_endpoints.PROJECT.GET_ALL.ENDPOINT;
const properties = ADMIN_endpoints.PROJECT.GET_ALL.PROPERTIES;

const displayName = ADMIN_endpoints.PROJECT.GET_ALL.DISPLAY_NAME;
const isDebug = true;

const Project_getAll = async () => {
  isDebug &&
