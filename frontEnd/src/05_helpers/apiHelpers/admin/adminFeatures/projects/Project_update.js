...
const endpoint = ADMIN_endpoints.PROJECT.UPDATE.ENDPOINT;
const properties = ADMIN_endpoints.PROJECT.UPDATE.PROPERTIES;

const displayName = ADMIN_endpoints.PROJECT.UPDATE.DISPLAY_NAME;
const isDebug = true;

const Project_update = async (payload) => {
  isDebug &&
