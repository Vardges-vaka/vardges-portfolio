...
const endpoint = ADMIN_endpoints.PROJECT.UPDATE_FILES.ENDPOINT;
const properties = ADMIN_endpoints.PROJECT.UPDATE_FILES.PROPERTIES;

const displayName = ADMIN_endpoints.PROJECT.UPDATE_FILES.DISPLAY_NAME;
const isDebug = true;

const Project_update_files = async (payload) => {
  isDebug &&
...
export default Project_update_files;
