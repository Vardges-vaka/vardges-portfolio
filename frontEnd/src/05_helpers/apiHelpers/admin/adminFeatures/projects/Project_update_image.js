...
const endpoint = ADMIN_endpoints.PROJECT.UPDATE_IMAGES.ENDPOINT;
const properties = ADMIN_endpoints.PROJECT.UPDATE_IMAGES.PROPERTIES;

const displayName = ADMIN_endpoints.PROJECT.UPDATE_IMAGES.DISPLAY_NAME;
const isDebug = true;

const Project_update_image = async (payload) => {
  isDebug &&
...
export default Project_update_image;
