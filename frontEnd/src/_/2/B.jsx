  ...
  return (
    <>
      <input 
        ...
        id="theme-mode" 
        type="checkbox" 
        readOnly // Add readOnly since no onChange handler
      />
      <div className="container">
        <div className="wrap">
          <input
            ...
            id="rd-1"
            type="radio"
            defaultChecked // Use defaultChecked instead of checked for uncontrolled
          />
          <label 
            style={{ "--index": 0 }} // Convert to object syntax
            className="label" 
            htmlFor="rd-1" // Use htmlFor instead of for
          >
            <span>About Me</span>
          </label>
          ...
          />
          <label 
            style={{ "--index": 1 }} // Convert to object syntax
            className="label" 
            htmlFor="rd-2" // Use htmlFor instead of for
          >
            <span>Summary</span>
          </label>
          ...
          />
          <label 
            style={{ "--index": 2 }} // Convert to object syntax
            className="label" 
            htmlFor="rd-3" // Use htmlFor instead of for
          >
            <span>Portfolio</span>
          </label>
          ...
          <label htmlFor="theme-mode" className="theme"> {/* Use htmlFor */}
            ...
            <span className="dark">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                strokeWidth="0"> {/* Use camelCase for strokeWidth */}
                <path
                  ...
                  fill="currentColor"
                  clipRule="evenodd" 
                  fillRule="evenodd"> {/* Use camelCase for fillRule */}
                </path>
              </svg>
            </span>
          </label>
