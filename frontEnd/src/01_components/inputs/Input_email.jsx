/**
 * USE CASE: Email text field with default Mail icon (left), same shell as Input_text.
 */
...
const Input_email = forwardRef(function Input_email(
  {
    labelProps = {},
    leftIconProps = {},
    rightIconProps = {},
  ...
  const rootClass = [
    baseStyle && "input_email",
    baseStyle && `input_email--${sizeType}`,
    isInlineLabel && "input_email--labelInline",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const fieldWrapClass = [
    "input_email__fieldWrap",
    resolvedLeftIcon.isActive && "input_email__fieldWrap--withLeftIcon",
    rightIconProps.isActive && "input_email__fieldWrap--withRightIcon",
    showLength && "input_email__fieldWrap--withLength",
    disabled && "input_email__fieldWrap--disabled",
    hintsProps.isActive &&
      hintsProps.type === "error" &&
      "input_email__fieldWrap--error",
    hintsProps.isActive &&
      hintsProps.type === "success" &&
      "input_email__fieldWrap--success",
  ]
    .filter(Boolean)
    .join(" ");

  const inlineRowClass = [
    "input_email__inlineRow",
    `input_email__inlineRow--label${inlinePosition}`,
  ].join(" ");
