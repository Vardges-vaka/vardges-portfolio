...
const Integration_statuses_active = () => {
  const {  isDarkMode } = useThemeContext();
const strokeColor = isDarkMode ? "#00ff08": "#0c6c11"
  

  const svgString = `
<svg width="64px" height="64px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="${strokeColor}" stroke="#00ff08" stroke-width="0.00016">
...
export default Integration_statuses_active;
