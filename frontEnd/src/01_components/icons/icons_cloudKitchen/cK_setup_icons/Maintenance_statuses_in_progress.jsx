const Maintenance_statuses_in_progress = () => {
  const svgString = `
<svg fill="#fbff00" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" xml:space="preserve" width="64px" height="64px" stroke="#fbff00">
...
export default Maintenance_statuses_in_progress;
