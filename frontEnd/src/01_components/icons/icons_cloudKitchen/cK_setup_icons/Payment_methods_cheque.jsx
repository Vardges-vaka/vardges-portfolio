...
<g id="ar"/> 
<g id="as"> 
<path d="M56.69,37.71l-14.01-.9-18.44,9.59,25.75,6.9c1.3,.35,2.63-.42,2.98-1.72l3.72-13.87Z" 
fill="#f5e680" 
fill-rule="evenodd"/> 
<polygon fill="#f2d865" fill-rule="evenodd" 
points="42.68 36.81 24.24 46.4 34.24 49.08 55.15 43.48 56.69 37.71 42.68 36.81"/> 
<path d="M18.78,47.86l1.75-13.1-8.95-13.77-4.77,1.28c-1.3,.35-2.07,1.68-1.72,2.98l5.94,22.17c.35,1.3,1.68,2.07,2.98,1.72l4.77-1.28Z" 
fill="#f0f3f5" fill-rule="evenodd"/> 
<path d="M50.72,10.62c-.24-.01-.48,.01-.73,.08L11.58,20.99l7.2,26.87,38.42-10.29c1.3-.35,2.07-1.68,1.72-2.98l-5.94-22.17c-.28-1.06-1.22-1.76-2.25-1.8Z" 
fill="#e8a3c1" fill-rule="evenodd"/> 
<path d="M51.63,20.61c-1-3.72-4.82-5.92-8.54-4.93-3.72,1-5.92,4.82-4.93,8.54s4.82,5.92,8.54,4.93c3.72-1,5.92-4.82,4.93-8.54Z" 
fill="#f0f3f5" fill-rule="evenodd"/> 
<path d="M57.19,37.57c1.3-.35,2.07-1.68,1.72-2.98l-5.94-22.17c-.28-1.06-1.22-1.76-2.25-1.8-.24-.01-.48,.01-.73,.08l-2.41,.64c.16-.02,.32-.04,.48-.03,1.04,.04,1.97,.74,2.25,1.8l5.94,22.17c.35,1.3-.42,2.63-1.72,2.98l2.65-.69Z" 
fill="#e38fb6" fill-rule="evenodd"/> 
...
</g> <g id="at"/> <g id="au"/> <g id="av"/> <g id="aw"/> <g id="ax"/> </g>
...
export default Payment_methods_cheque;
