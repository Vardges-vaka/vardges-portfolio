const Maintenance_statuses_completed = () => {
  const svgString = `
<svg width="64px" height="64px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#44ff00" stroke="#44ff00" stroke-width="0.00048000000000000007">
...
export default Maintenance_statuses_completed;
