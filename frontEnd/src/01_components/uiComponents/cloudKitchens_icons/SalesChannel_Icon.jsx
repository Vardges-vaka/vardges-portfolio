...
const SalesChannel_Icon = () => {
  const { strokeColor } = useThemeContext();

  const svgString = `

<svg fill="${strokeColor}" xmlns="http://www.w3.org/2000/svg" width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
...
<path d="M54.8,52.4c-2.1-0.9-2.5-1.8-2.5-2.6c0-0.9,0.6-1.8,1.3-2.4c1.2-1.2,1.9-2.8,1.9-4.6c0-3.5-2.1-6.5-5.9-6.5 s-5.9,3-5.9,6.5c0,1.9,0.7,3.5,1.9,4.6c0.7,0.7,1.3,1.5,1.3,2.4s-0.3,1.7-2.5,2.6c-3.1,1.3-6,2.8-6.1,5.6c0,1.9,1.4,3.4,3.2,3.4 h16.3c1.8,0,3.2-1.5,3.2-3.4C60.9,55.2,57.9,53.8,54.8,52.4z"/> </g>
...
export default SalesChannel_Icon;
