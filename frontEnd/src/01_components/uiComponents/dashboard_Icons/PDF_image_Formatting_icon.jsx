...
const PDF_image_Formatting_icon = () => {
  const { strokeColor } = useThemeContext();

  const svgString = `
<svg fill="${strokeColor}" width="64px" height="64px" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
...
export default PDF_image_Formatting_icon;
