...
import "../../_styles/dailySales_YYY_ZZZ.css";

const DailySales_YYY_ZZZ = ({ states, handlers, t }) => {
  return (
    // Root element: <div> with the full 3-level lineage as className.
    // Internal classNames: xXX_YYY_ZZZ_[elementName]
    <div className="dailySales_YYY_ZZZ">
      {/* Example internal element */}
      <span className="dailySales_YYY_ZZZ_label">{t("sampleChildLabel")}</span>
    </div>
  );
};

export default DailySales_YYY_ZZZ;
