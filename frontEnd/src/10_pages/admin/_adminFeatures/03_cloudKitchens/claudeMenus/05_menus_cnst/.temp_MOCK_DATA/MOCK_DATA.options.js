...
const MOCK_OPTION_1 = {
  _id: "1.1.1.1",
  ...attachSales("1.1.1.1"),
  ...{ pastOrders: generatePastOrders("1.1.1.1", { count: 50 }) },
  ownerType: "brand",
...
const MOCK_OPTION_2 = {
  _id: "1.1.1.2",
  ...attachSales("1.1.1.2"),
  ...{ pastOrders: generatePastOrders("1.1.1.2", { count: 50 }) },
  ownerType: "brand",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: false,
  displayOrder: 1,
...
const MOCK_OPTION_3 = {
  _id: "1.1.1.3",
  ...attachSales("1.1.1.3"),
  ...{ pastOrders: generatePastOrders("1.1.1.3", { count: 50 }) },
  ownerType: "franchise",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 2,
...
const MOCK_OPTION_4 = {
  _id: "1.1.1.4",
  ...attachSales("1.1.1.4"),
  ...{ pastOrders: generatePastOrders("1.1.1.4", { count: 50 }) },
  ownerType: "branch",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 3,
...
const MOCK_OPTION_5 = {
  _id: "1.1.1.5",
  ...attachSales("1.1.1.5"),
  ...{ pastOrders: generatePastOrders("1.1.1.5", { count: 50 }) },
  ownerType: "brand",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: false,
  displayOrder: 4,
...
const MOCK_OPTION_6 = {
  _id: "1.1.1.6",
  ...attachSales("1.1.1.6"),
  ...{ pastOrders: generatePastOrders("1.1.1.6", { count: 50 }) },
  ownerType: "franchise",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 5,
...
const MOCK_OPTION_7 = {
  _id: "1.1.1.7",
  ...attachSales("1.1.1.7"),
  ...{ pastOrders: generatePastOrders("1.1.1.7", { count: 50 }) },
  ownerType: "brand",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 6,
...
const MOCK_OPTION_8 = {
  _id: "1.1.1.8",
  ...attachSales("1.1.1.8"),
  ...{ pastOrders: generatePastOrders("1.1.1.8", { count: 50 }) },
  ownerType: "branch",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: false,
  displayOrder: 7,
...
const MOCK_OPTION_9 = {
  _id: "1.1.1.9",
  ...attachSales("1.1.1.9"),
  ...{ pastOrders: generatePastOrders("1.1.1.9", { count: 50 }) },
  ownerType: "franchise",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 8,
...
const MOCK_OPTION_10 = {
  ...
  ...{ pastOrders: generatePastOrders("1.1.1.10", { count: 50 }) },
  ownerType: "brand",
  ownerId: "mongoose.Schema.Types.ObjectId Sample",
  isActive: true,
  displayOrder: 9,
