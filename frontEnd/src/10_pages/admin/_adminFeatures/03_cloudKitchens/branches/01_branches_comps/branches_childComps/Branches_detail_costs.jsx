...
const Branches_detail_costs = ({
  ...
  const renderReadonly = () => (
    <div className="branchesDetailCosts__readonly">
      ...
      <h4 className="branchesDetailSection__subTitle">{t("fields.utilities")}</h4>
      <dl className="branchesDetailSection__dl">
          ...
          return (
            <div key={index} className="branchesDetailCosts__variableRow">
              <input
                className={
                  "branchesDetailSection__input" +
                  (rowErr("label") ? " branchesDetailSection__input--error" : "")
                }
                type="text"
                placeholder={t("fields.label")}
                value={row?.label ?? ""}
                onChange={(e) => onVariableChange(index, "label", e.target.value)}
              />
              <input
                className={
                  "branchesDetailSection__input" +
                ...
                value={row?.amount ?? ""}
                onChange={(e) => onVariableChange(index, "amount", e.target.value)}
              />
              <input
                className={
                  "branchesDetailSection__input" +
                ...
                type="date"
                value={row?.date ?? ""}
                onChange={(e) => onVariableChange(index, "date", e.target.value)}
              />
              <input
                className={
                  "branchesDetailSection__input" +
                  (rowErr("notes") ? " branchesDetailSection__input--error" : "")
                }
                type="text"
                placeholder={t("fields.notes")}
                value={row?.notes ?? ""}
                onChange={(e) => onVariableChange(index, "notes", e.target.value)}
              />
              <button
                type="button"
...
export default Branches_detail_costs;
