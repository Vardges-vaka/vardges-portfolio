...
const Branches_detail_location = ({
  branch,
  draft,
  isEditing,
  isBulkEdit,
      ...
      <div className="branchesDetailLocation__viewToggle" role="tablist">
        <button
          ...
          className={
            ...
            (locationViewMode === "list" ? " branchesDetailLocation__toggleBtn--active" : "")
          }
        ...
        <button
          ...
          className={
            "branchesDetailLocation__toggleBtn" +
            (locationViewMode === "map" ? " branchesDetailLocation__toggleBtn--active" : "")
          }
  ...
  const renderEditable = () => (
    <>
      ...
      <div className="branchesDetailSection__grid">
        <div className="branchesDetailSection__field">
          <label className="branchesDetailSection__label">{t("fields.lat")}</label>
          <input
            className={
              "branchesDetailSection__input" +
        ...
        <div className="branchesDetailSection__field">
          <label className="branchesDetailSection__label">{t("fields.lng")}</label>
          <input
            className={
              "branchesDetailSection__input" +
...
export default Branches_detail_location;
