...
const Branches_mapView_info_operationsPopover = ({
  t,
  ops,
  anchorEl,
  onClose,
  ...
  const hintText = (() => {
    ...
    if (hint.kind === "open")
      return t("mapView.opsPopoverClosesAt", { time: hint.closesAt });
    if (hint.opensTomorrow)
      return t("mapView.opsPopoverOpensAtTomorrow", { time: hint.opensAt });
  ...
  const hoursLine = [formatTime(ops?.openingTime), formatTime(ops?.closingTime)]
    .filter(Boolean)
    .join(" – ");
  ...
  const node = (
    <div
      ...
      <span
        className="branchesMapViewInfo__contactPopoverArrow"
        style={{ left: pos.arrowLeft }}
        aria-hidden
      />
      <div className="branchesMapViewInfo__contactPopoverHeader">
        <span className="branchesMapViewInfo__contactPopoverTitle">
          {title}
        </span>
        <button
          type="button"
      ...
      <div className="branchesMapViewInfo__opsPopoverBody">
        {hint.kind === "inactive" ? (
          <p className="branchesMapViewInfo__opsPopoverMuted">
            {t("mapView.opsPopoverInactive")}
          </p>
        ) : (
          <>
                ...
                <dd className="branchesMapViewInfo__opsPopoverDd">
                  <span
                    className={
                      ...
                      (openNow
                        ? " branchesMapViewInfo__opsPopoverPill--on"
                        : " branchesMapViewInfo__opsPopoverPill--off")
                    }>
            ...
            {hintText ? (
              <p className="branchesMapViewInfo__opsPopoverHint">{hintText}</p>
            ) : null}
          </>
        )}
      </div>
