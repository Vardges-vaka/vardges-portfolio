...
const Branches_mapView_info_contactPopover = ({
  t,
  title,
  contact,
  anchorEl,
  ...
  const node = (
    <div
      ...
      {channels.length === 0 ? (
        <p className="branchesMapViewInfo__contactPopoverEmpty">
          {t("mapView.infoNoContactChannels")}
        </p>
      ) : (
        <ul className="branchesMapViewInfo__contactPopoverList">
          {channels.map((ch) => (
            <li key={ch.key} className="branchesMapViewInfo__cpRow">
              <span
                className="branchesMapViewInfo__cpIconWrap"
                title={t(ch.labelKey)}>
              ...
              <div className="branchesMapViewInfo__cpSlide">
                ...
                <button
                  ...
                  {copiedKey === ch.key
                    ? t("mapView.contactPopoverCopied")
                    : t("mapView.contactPopoverCopy")}
                </button>
                {ch.href ? (
                  <a
