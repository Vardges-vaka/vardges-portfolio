...
} from "./_branches_mapView_info.index.js";
...
const Branches_mapView_info = ({
  ...
  const branch = useMemo(() => {
    ...
    return (
      (branches ?? []).find(
        (b) => String(b._id) === String(infoPanelBranchId),
      ) ?? null
    );
  ...
  const ariaLabel = summaryCollapsed
    ? t("mapView.infoSummaryTitle")
    : t("mapView.infoBranchTitle");
      ...
      <div className="branchesMapViewInfo__collapseBar">
          ...
          <div className="branchesMapViewInfo__collapseBarMain">
            {summaryCollapsed ? (
              <>
                ...
                <span className="branchesMapViewInfo__collapseValue">
                  {t("empty.noValue")}
                </span>
                ...
                <span
                  className="branchesMapViewInfo__collapseDate"
                  title={dailyRangeLabel}>
                  {dailyRangeLabel}
                </span>
              </>
            ) : (
        ...
        <div className="branchesMapViewInfo__collapseBarEnd">
          {!summaryCollapsed ? (
            <button
              ...
              className={
                ...
                (branchIs24h
                  ? ""
                  : " branchesMapViewInfo__operationsTrigger--not24h")
              }
          ...
          <button
            ...
            title={
              mapInfoExpanded
                ? t("mapView.infoToggleCollapse")
                : t("mapView.infoToggleExpand")
            }>
            <span
              className="branchesMapViewInfo__collapseToggleIcon"
              aria-hidden>
              {mapInfoExpanded ? "▾" : "▸"}
            </span>
          </button>
        ...
        {summaryCollapsed ? (
          <>
            <header className="branchesMapViewInfo__header branchesMapViewInfo__header--inPanel">
              <h3 className="branchesMapViewInfo__title">
                {t("mapView.infoSummaryTitle")}
              </h3>
            </header>
              ...
              {["daily", "weekly", "monthly"].map((p) => (
                <button
                  ...
                  className={
                    ...
                    (mapSummaryPeriod === p
                      ? " branchesMapViewInfo__periodBtn--active"
                      : "")
                  }
            ...
            <p className="branchesMapViewInfo__range">
              <span className="branchesMapViewInfo__rangeLabel">
                {t("mapView.infoRangeLabel")}:
              </span>{" "}
              {rangeLabel}
            </p>

            <p className="branchesMapViewInfo__hint">
              {t("mapView.infoDataPending")}
            </p>

            <div className="branchesMapViewInfo__kpis">
              <div className="branchesMapViewInfo__kpi">
                <span className="branchesMapViewInfo__kpiLabel">
                  {t("mapView.infoSalesTotal")}
                </span>
                <span className="branchesMapViewInfo__kpiValue">
                  {t("empty.noValue")}
                </span>
              </div>
              <div className="branchesMapViewInfo__kpi">
                <span className="branchesMapViewInfo__kpiLabel">
                  {t("mapView.infoOrdersCount")}
                </span>
                <span className="branchesMapViewInfo__kpiValue">
                  {t("empty.noValue")}
                </span>
          ...
          <>
            <header className="branchesMapViewInfo__header branchesMapViewInfo__header--inPanel">
              ...
              <button
                type="button"
                className="branchesMapViewInfo__backBtn"
                onClick={onClearBranchInfo}>
              ...
              <details className="branchesMapViewInfo__details branchesMapViewInfo__details--accordion">
                <summary className="branchesMapViewInfo__detailsSummary">
                  <img
                    ...
                    draggable={false}
                  />
                  <span className="branchesMapViewInfo__detailsSummaryLabel">
                    {t("sections.employees")}
                  </span>
                  <span className="branchesMapViewInfo__detailsSummaryCount">
                  ...
                  {(branch.images ?? []).map((url, i) => (
                    <li key={i}>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="branchesMapViewInfo__imgLink">
