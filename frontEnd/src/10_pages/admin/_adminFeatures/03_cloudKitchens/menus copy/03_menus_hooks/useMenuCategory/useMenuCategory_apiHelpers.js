/* ============================================================================
   useMenuCategory_apiHelpers — thin wrappers around the backend endpoints for
   Category documents. Mirrors useMenus_apiHelpers.js — the calls are
...
const useMenuCategory_apiHelpers = () => {
  // ---- READ ----
...
export default useMenuCategory_apiHelpers;
