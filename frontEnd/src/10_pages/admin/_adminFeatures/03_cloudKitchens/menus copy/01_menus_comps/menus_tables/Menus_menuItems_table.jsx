            ...
            return (
              ...
              <tr
                ...
                <td
                  ...
                  data-quickview-open={expandedId === menuItem._id ? "true" : "false"}>
                  <button
                    className="menus_view_all_table_rows_provider_cell_button dropdown"
                    data-id={menuItem._id}
                    aria-expanded={expandedId === menuItem._id}
                    onClick={() =>
                      setExpandedId(expandedId === menuItem._id ? null : menuItem._id)
                    }>
                    {expandedId === menuItem._id ? "Close" : "Quick"}
                  </button>
                </td>
              </tr>
              <Menus_quickView
                open={expandedId === menuItem._id}
                colSpan={menuItemsTableHeaders.length}
                fields={[
                  { label: "SKU", value: menuItem.sku },
                  { label: "Owner", value: menuItem.ownerType },
                  ...
                  { label: "Spicy level", value: menuItem.spicyLevel },
                  { label: "Prep time", value: menuItem.preparationTimeMin ? `${menuItem.preparationTimeMin}m` : "—" },
                  { label: "Selling price", value: `${menuItem.sellingPrice.gross} (net ${menuItem.sellingPrice.net}, VAT ${menuItem.sellingPrice.VAT})` },
                  { label: "Cost", value: `est. ${menuItem.cost.estimatedCost} / actual ${menuItem.cost.actualCost}` },
                  { label: "Dietary tags", value: (menuItem.dietaryTags || []).join(", ") || "—" },
                  { label: "Allergens", value: (menuItem.allergens || []).join(", ") || "—" },
                  { label: "Available in", value: (menuItem.availableInCategories || []).join(", ") || "—" },
                ]}
                sections={[
                  {
