...
/* ============================================================================
   Menus_option_view_one — full detail view for a single Option (modifier
   option). Same patterns as MenuItem_view_one: image stack + fields, fact
   grid, files + drop zone.
============================================================================ */
  ...
  return (
    <div className="menus_option_view_one menus_menuItem_view_one">
        ...
        <aside className="menus_menuItem_view_one_topRight">
          ...
          <div className="menus_menuItem_view_one_topRight_name">
            <div className="menus_menuItem_view_one_topRight_name_label">
              ...
              <div className="menus_menuItem_view_one_topRight_controlls">
                <Menus_iconUpdateBtn
                  ...
                  active={showNameTrans}
                  onClick={() => setShowNameTrans((v) => !v)}
                />
                <Menus_iconUpdateBtn
                  icon={<Pencil size={16} />}
                  tooltip="Update Name"
            ...
            <input
              ...
              defaultValue={option.name?.label}
              readOnly={!updatingName}
            />
            {showNameTrans && (
              <Menus_translations
                title="Name — translations"
                data={option.name?.translations || {}}
              />
            )}
          </div>
                ...
                <div className="menus_menuItem_view_one_topRight_description_version_label">
                  ...
                  <div style={{ display: "inline-flex", gap: 2 }}>
                    ...
                    <Menus_iconUpdateBtn
                      ...
                      onClick={() => handlers.startFieldUpdate?.("description.short", option.description?.short?.en ?? option.description?.short)}
                    />
                  </div>
                </div>
                <textarea
                ...
                <div className="menus_menuItem_view_one_topRight_description_version_label">
                  ...
                  <div style={{ display: "inline-flex", gap: 2 }}>
                    ...
                    <Menus_iconUpdateBtn
                      ...
                      onClick={() => handlers.startFieldUpdate?.("description.long", option.description?.long?.en ?? option.description?.long)}
                    />
                  </div>
                </div>
                <textarea
      ...
      <section
        ...
        <FactCell label="Owner" value={option.ownerType} />
        ...
        <FactCell
          ...
          value={
            option.cloudStorage
              ? `${option.cloudStorage.value}${option.cloudStorage.isDefault ? " (default)" : ""}`
              : "—"
          }
        />
        <FactCell label="Available in modifiers" value={(option.availableInModifiers || []).join(", ") || "—"} wrap />
        <FactCell label="Created" value={`${option.createdBy || "—"} · ${formatDate(option.createdAt)}`} wrap />
        <FactCell label="Updated" value={`${option.updatedBy || "—"} · ${formatDate(option.updatedAt)}`} wrap />
      </section>
