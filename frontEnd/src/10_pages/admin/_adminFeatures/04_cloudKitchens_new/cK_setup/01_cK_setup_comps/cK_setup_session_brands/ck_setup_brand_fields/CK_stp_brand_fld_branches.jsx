...
import "../../../_styles/cK_setup_session_brands/ck_setup_brand_fields/cK_stp_brand_fld_branches.css";

const CK_stp_brand_fld_branches = ({ states, handlers, t }) => {
  ...
  return (
    <section className="cK_stp_brand_fld_branches">
      <h4 className="cK_setup_form_sectionTitle">CK_stp_brand_fld_branches</h4>
      {/* <Input_text
        labelProps={{
          isActive: true,
          message: "Russian:",
...
export default CK_stp_brand_fld_branches;
