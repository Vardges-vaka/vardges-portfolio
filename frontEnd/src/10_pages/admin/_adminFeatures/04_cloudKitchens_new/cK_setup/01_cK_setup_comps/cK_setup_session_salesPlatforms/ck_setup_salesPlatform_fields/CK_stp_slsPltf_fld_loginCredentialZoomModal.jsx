...
const CK_stp_slsPltf_fld_loginCredentialZoomModal = ({
  isOpen,
  item,
  index,
  partnerPortalUrl,
  ...
  const renderActionButtons = (fieldKey, rawValue, href) => {
    ...
    return (
      <span className="cK_stp_slsPltf_fld_loginCredentials__zoomActions">
        <button
          type="button"
          className={[
            "cK_stp_slsPltf_fld_loginCredentials__actionBtn",
            isCopied && "cK_stp_slsPltf_fld_loginCredentials__actionBtn--copied",
          ]
            .filter(Boolean)
            .join(" ")}
        ...
        {href ? (
          <a
            className="cK_stp_slsPltf_fld_loginCredentials__actionBtn"
            href={href}
            title="Open link"
          ...
          <span
            className="cK_stp_slsPltf_fld_loginCredentials__actionBtn cK_stp_slsPltf_fld_loginCredentials__actionBtn--disabled"
            aria-hidden="true">
  ...
  return (
    <Modal isOpen={isOpen} title={title} onCancel={onClose}>
      <div className="cK_stp_slsPltf_fld_loginCredentials__zoomModalBody">
        {LOGIN_CREDENTIAL_CARD_FIELDS.map((field) => {
          ...
          return (
            <div
              key={field.key}
              className={[
                "cK_stp_slsPltf_fld_loginCredentials__zoomRow",
                isMultiline &&
                  "cK_stp_slsPltf_fld_loginCredentials__zoomRow--multiline",
                showActions &&
                  "cK_stp_slsPltf_fld_loginCredentials__zoomRow--withActions",
              ]
                .filter(Boolean)
                .join(" ")}
              style={
              ...
              <span className="cK_stp_slsPltf_fld_loginCredentials__zoomLabel">
                {field.label}
              </span>
              <span
                className={[
                  "cK_stp_slsPltf_fld_loginCredentials__zoomValue",
                  isEmpty && "cK_stp_slsPltf_fld_loginCredentials__zoomValue--empty",
                ]
                  .filter(Boolean)
                  .join(" ")}>
...
export default CK_stp_slsPltf_fld_loginCredentialZoomModal;
