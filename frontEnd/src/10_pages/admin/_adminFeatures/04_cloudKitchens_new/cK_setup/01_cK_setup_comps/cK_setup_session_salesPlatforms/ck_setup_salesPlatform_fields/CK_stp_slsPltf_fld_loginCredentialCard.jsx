...
const ICON_TONE_CLASS = {
  primary: "cK_stp_slsPltf_fld_loginCredentials__iconTone--primary",
  secondary: "cK_stp_slsPltf_fld_loginCredentials__iconTone--secondary",
  tertiary: "cK_stp_slsPltf_fld_loginCredentials__iconTone--tertiary",
};
...
const CK_stp_slsPltf_fld_loginCredentialCard = ({
  item,
  index,
  disabled,
  onZoom,
  ...
  return (
    <article className="cK_stp_slsPltf_fld_loginCredentials__card">
      <div className="cK_stp_slsPltf_fld_loginCredentials__cardHead">
        <h5 className="cK_stp_slsPltf_fld_loginCredentials__cardTitle">{title}</h5>

        <div className="cK_stp_slsPltf_fld_loginCredentials__cardHeadActions">
          <button
            type="button"
            className={[
              "cK_stp_slsPltf_fld_loginCredentials__iconBtn",
      ...
      <div className="cK_stp_slsPltf_fld_loginCredentials__cardBody">
        {LOGIN_CREDENTIAL_CARD_PREVIEW_FIELDS.map((field) => {
          ...
          return (
            <div
              key={field.key}
              className={[
                "cK_stp_slsPltf_fld_loginCredentials__cardRow",
                isCopyable && "cK_stp_slsPltf_fld_loginCredentials__cardRow--copyable",
              ]
                .filter(Boolean)
                .join(" ")}>
              <span
                className={[
                  "cK_stp_slsPltf_fld_loginCredentials__cardRowIcon",
              ...
              <span
                className={[
                  "cK_stp_slsPltf_fld_loginCredentials__cardValue",
                  !hasText(rawValue) &&
                    "cK_stp_slsPltf_fld_loginCredentials__cardValue--empty",
                ]
                  .filter(Boolean)
                  .join(" ")}
              ...
              {isCopyable ? (
                <button
                  type="button"
                  className={[
                    "cK_stp_slsPltf_fld_loginCredentials__cardCopyBtn",
                    ICON_TONE_CLASS.primary,
                    isCopied &&
                      "cK_stp_slsPltf_fld_loginCredentials__cardCopyBtn--copied",
                  ]
                    .filter(Boolean)
                    .join(" ")}
...
export default CK_stp_slsPltf_fld_loginCredentialCard;
