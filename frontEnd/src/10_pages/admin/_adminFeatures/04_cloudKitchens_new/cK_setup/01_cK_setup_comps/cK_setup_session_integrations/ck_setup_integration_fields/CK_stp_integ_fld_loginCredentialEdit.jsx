...
const CK_stp_integ_fld_loginCredentialEdit = ({
  index,
  item,
  disabled,
  onChange,
  ...
  return (
    <div className="cK_stp_integ_fld_loginCredentials__editPanel">
      <Input_text
      ...
      <div className="cK_stp_integ_fld_loginCredentials__editActions">
        <button
          type="button"
...
export default CK_stp_integ_fld_loginCredentialEdit;
