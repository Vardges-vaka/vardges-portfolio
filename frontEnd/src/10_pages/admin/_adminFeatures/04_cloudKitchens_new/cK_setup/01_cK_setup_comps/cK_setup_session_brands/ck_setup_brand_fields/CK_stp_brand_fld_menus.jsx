...
import "../../../_styles/cK_setup_session_brands/ck_setup_brand_fields/cK_stp_brand_fld_menus.css";

const CK_stp_brand_fld_menus = ({ states, handlers, t }) => {
  ...
  return (
    <section className="cK_stp_brand_fld_menus">
      <h4 className="cK_setup_form_sectionTitle">CK_stp_brand_fld_menus</h4>
      {/* <Input_text
        labelProps={{
          isActive: true,
          message: "Russian:",
...
export default CK_stp_brand_fld_menus;
