...
import "../../../_styles/cK_setup_session_brands/ck_setup_brand_fields/cK_stp_brand_fld_equipments.css";

const CK_stp_brand_fld_equipments = ({ states, handlers, t }) => {
  ...
  return (
    <section className="cK_stp_brand_fld_equipments">
...
export default CK_stp_brand_fld_equipments;
