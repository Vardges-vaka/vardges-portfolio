...
const displayName = " | brand_putSection_srv.js | ";

export const brand_putSection_srv = async (req, isDebug) => {
  try {
    ...
    return { success: true, message: "Brand section updated successfully", data: populated };
  } catch (error) {
