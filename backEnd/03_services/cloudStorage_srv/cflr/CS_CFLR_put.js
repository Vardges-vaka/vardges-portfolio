...
const displayName = " | CS_CFLR_put.js | ";
const MULTIPART_THRESHOLD_BYTES = 5 * 1024 * 1024;

const CS_CFLR_put = async (params, isDebug = false) => {
  ...
  try {
    ...
    return {
      ...
      data: { bucket: R2_BUCKET_NAME, objectKey: key, contentType, bytes: size },
    };
  } catch (error) {
